...
This file is created once by `project-workspace-init`. Add project-specific rules below without replacing existing user content.

## Workspace

- The Main Workspace is the formal Git repository.
